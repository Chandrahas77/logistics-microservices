...
func (c *warehouseServiceClient) AddInventory(ctx context.Context, in *AddInventoryRequest, opts ...grpc.CallOption) (*AddInventoryResponse, error) {
...
func (UnimplementedWarehouseServiceServer) AddInventory(context.Context, *AddInventoryRequest) (*AddInventoryResponse, error) {
